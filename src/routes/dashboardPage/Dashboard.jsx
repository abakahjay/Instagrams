...
// import React, { useState, useRef } from "react";
// import {
//   Box, Flex, Text, Textarea, IconButton, Button
// } from "@chakra-ui/react";
// import { FaMicrophone } from "react-icons/fa";
// import { FiPlus } from "react-icons/fi";
// import { IoIosArrowRoundUp } from "react-icons/io";
...
//   const { createUserChat, sendMessage, uploadImage } = useAiChatActions();
//   const showToast = useShowToast();
...
//     try {
//       const textToSend = trimmed || "Image Upload";
//       const { savedChat } = await createUserChat(userId, { text: textToSend });
//       console.log(savedChat)
//       const chatId = savedChat._id;

//       if (trimmed) await sendMessage(userId, chatId, trimmed);

//       if (fileInfo && fileBlob) {
//         const formData = new FormData();
//         formData.append("file", fileBlob);
//         formData.append("text", textToSend);
//         await uploadImage(userId, chatId, formData);
//       }
...
//     const reader = new FileReader();
//     reader.onload = () => {
//       setFileInfo({ name: file.name, type: file.type, size: `${size} KB`, base64: reader.result });
//     };
...
//         <Flex direction="column" bg="#121212" borderRadius="xl" px={4} py={4} boxShadow="lg">
//           {fileInfo && (
//             <Box mb={3} color="gray.300" fontSize="sm">
//               <Text>📄 {fileInfo.name}</Text>
...
//           {transcript && (
//             <Flex bg="gray.700" px={3} py={2} borderRadius="md" mb={3} align="center">
//               <Text flex="1">{transcript}</Text>
//               <Button size="sm" colorScheme="green" mr={2} onClick={stopListening}>Accept</Button>
//               <Button size="sm" colorScheme="red" onClick={cancelListening}>Discard</Button>
//             </Flex>
//           )}

//           <Flex align="center" gap={2} bg="transparent" px={2} py={2} border="1px solid gray" borderRadius="md">
//             <input type="file" hidden ref={fileInputRef} onChange={handleFileChange} />
//             <IconButton icon={<FiPlus />} variant="ghost" aria-label="Attach" color="gray.300" onClick={() => fileInputRef.current.click()} />
//             <Textarea
//               placeholder="Ask anything..."
//               value={input}
//               onChange={(e) => setInput(e.target.value)}
...
//             />
//             <IconButton icon={<FaMicrophone />} variant="ghost" aria-label="Mic" color="gray.300" onClick={startListening} />
//             <IconButton
//               icon={<IoIosArrowRoundUp style={{ fontSize: "28px" }} />}
//               aria-label="Send"
//               onClick={handleSend}
//               isRound
//               bg={input.trim() || fileInfo ? "white" : "transparent"}
//               color={input.trim() || fileInfo ? "black" : "gray.400"}
//               _hover={{ bg: input.trim() || fileInfo ? "whiteAlpha.800" : "gray.700" }}
//             />
//           </Flex>
//         </Flex>
//       </Box>
